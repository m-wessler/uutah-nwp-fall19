function k = menu_asl(xHeader,varargin);
...
%   $Revision: 5.20 $  $Date: 2001/04/15 12:03:27 $
...
%ASL
winTopGap   = 288;       % gap between top of screen and top of figure **
winLeftGap  = 400;       % gap between side of screen and side of figure **
...
%ASL
set( menuFig, 'Position', [winLeftGap winTopGap winWide winHigh] );
